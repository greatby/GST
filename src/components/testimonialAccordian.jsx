...
const testimonials = [
  ...
  },
  {
    ...
    name: "Shveta Malhan",
    quote:
      "I love that Lattice makes it so our people leaders don’t have to hunt for info. Whether they are having one-on-ones, giving feedback, or engaging in a review cycle, our managers have all the context and information they need at their fingertips thanks to Lattice.",
    image: "/images/hr.jpg",
  ...
  },
  {
    ...
    name: "Heather Dunn",
    quote:
      "Lattice is central to performance and career development at Brex — whether for quarterly check-ins or growth talks, its intuitive design and AI-powered insights help managers support their teams and empower employees to focus on the work that matters most to their growth.",
  ...
  },
  {
    ...
    name: "Kevin McCarthy",
    quote:
      "We partner with Lattice to build thoughtful systems that help scale our organization, culture, and communications, because building something long-lasting means getting it right from the start.",
            ...
            return (
              <div
                ...
                className={`relative cursor-pointer rounded-xl overflow-hidden shadow-md border transition-all duration-300 flex-shrink-0 ${
                  isActive
                    ? "bg-white w-[500px]"
                    : "bg-white w-[180px] hover:bg-gray-100"
                }`}
              >
                {/* Image & Logo */}
                <div className="flex items-start gap-3 p-4">
                  ...
                  <img
                    src={item.logo}
                    alt=""
                    className="w-8 h-8 mt-2 ml-auto"
                  />
                </div>
                ...
                {/* <AnimatePresence>
                  {isActive && (
                    <motion.div
                      ...
                      exit={{ opacity: 0, x: -40 }}
                      transition={{ duration: 0.4 }}
                      className="absolute inset-0 bg-white p-6 z-10 rounded-xl hidden md:flex gap-6"
                    >
