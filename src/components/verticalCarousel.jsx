...
const slideData = [
  {
    ...
    bg: "bg-white",
    image:
      "https://cdn.prod.website-files.com/64ad6f1aef87635bd23449f1/67dc1986de3f500ad54276b6_payrol-value-prop-1%20(1).webp",
    // author: {
    //   name: 'Elymi Peralta',
  ...
  },
  {
    ...
    bg: "bg-[#f0f4ff]",
    image:
      "https://cdn.prod.website-files.com/64ad6f1aef87635bd23449f1/67dc1cc09d9f7ba0f5b873d4_payroll-value-prop-2.webp",
    // author: {
    //   name: 'OpenWorks',
    //   quote:
  ...
  },
  {
    ...
    bg: "bg-[#e7fbe9]",
    image:
      "https://cdn.prod.website-files.com/64ad6f1aef87635bd23449f1/67dc241711ef095624da4cc2_payroll-value-prop-03.webp",
    cards: gridThree,
  },
];
    ...
    <div className="relative h-screen overflow-hidden">
      ...
      >
        {slideData.map((slide, idx) => (
          <Slide key={slide.id || idx} {...slide} cards={slide.cards} />
        ))}
      </div>
    </div>
  );
